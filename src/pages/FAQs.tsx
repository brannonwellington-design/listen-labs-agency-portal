...
const faqCategories = [
  {
    ...
    faqs: [
      ...
      { q: "How does AI moderation actually work?", a: "You upload a discussion guide and define your target audience. Listen's AI conducts video interviews that adapt in real-time based on responses, asking follow-up probes just like a human moderator would." },
      { q: "What do respondents actually experience?", a: "Respondents receive a link, join from any device with a camera, and have a natural video conversation on their own schedule. No app download required. It feels like a video call, not a survey." },
      { q: "What do I get as output?", a: "A comprehensive analysis including themes, sentiment analysis, key quotes, video highlight reels, and exportable reports. Everything is linked to source video for verification." },
      ...
      { q: "Is the quality comparable to human moderation?", a: "For most use cases, yes. The AI moderator is consistent across every interview, never gets tired, and follows your guide precisely while probing naturally. Clients see linked verbatim quotes and timestamped video clips — more transparent than traditional research." },
      { q: "Is Listen secure?", a: "Yes. Listen is SOC 2 Type II certified, GDPR compliant, HIPAA compliant, and ISO 27001 certified." },
    ],
  },
  {
    icon: Rocket,
    ...
    faqs: [
      ...
      { q: "Can Listen do shop-alongs and ethnographies?", a: "Yes. Respondents can record their shopping experience or show their home environment in real-time while the AI moderator asks contextual questions." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Can we create client-ready presentations?", a: "Yes, Listen automatically generates executive summaries and presentation-ready decks from your study results." },
      { q: "How do video highlights work?", a: "AI automatically identifies key moments and creates shareable video clips with quotes, organized by theme or sentiment." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How do panel incentives work?", a: "If using integrated panels, incentives are paid per participant and vary by audience difficulty and market." },
  ...
  },
  {
    ...
    subtitle: "Honest about what Listen isn't great for",
    faqs: [
      ...
      { q: "What about very niche B2B audiences?", a: "Listen handles the interview brilliantly, but recruiting very niche B2B audiences (e.g., C-suite at Fortune 500) is still a recruitment challenge regardless of methodology. Bring your own panel for these." },
    ],
  },
];
