...
const faqCategories = [
  {
    ...
    faqs: [
      ...
      { q: "How fast are results?", a: "Most studies complete in 2-5 days from launch to final analysis, compared to 4-8 weeks for traditional qual research." },
  ...
  },
  {
    ...
    faqs: [
      { q: "How long does it take to set up a study?", a: "Most agencies launch their first study within a day. Upload a discussion guide, define your audience, and Listen handles the rest." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How are studies priced?", a: "Pricing is based on interview duration and number of participants. Credits are consumed for AI moderation and analysis." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Does Listen work for live group discussions?", a: "No. Listen focuses on 1-on-1 AI-moderated interviews. If your client needs live focus groups with a human moderator, Listen isn't the right tool for that study." },
      ...
      { q: "Can Listen replace all qualitative research?", a: "No, and we don't position it that way. Listen is best positioned as an upgrade to your research workflow for the right studies, not a wholesale replacement for human-led qual." },
